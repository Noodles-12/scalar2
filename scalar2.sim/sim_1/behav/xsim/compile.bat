...
REM
REM Generated by Vivado on Thu Apr 16 08:53:40 -0500 2026
...
echo "xvlog --incr --relax -L uvm -prj fetch_decode_pl_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj fetch_decode_pl_tb_vlog.prj -log xvlog.log
