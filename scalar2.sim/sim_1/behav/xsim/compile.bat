...
REM
REM Generated by Vivado on Sun Apr 19 17:53:28 -0500 2026
...
echo "xvlog --incr --relax -L uvm -prj fetch_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj fetch_tb_vlog.prj -log xvlog.log
