...
REM
REM Generated by Vivado on Sat Apr 11 23:07:39 -0500 2026
...
echo "xvlog --incr --relax -L uvm -prj alu_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj alu_tb_vlog.prj -log xvlog.log
