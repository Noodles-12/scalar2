...
REM
REM Generated by Vivado on Fri Apr 17 19:40:59 -0500 2026
...
echo "xvlog --incr --relax -L uvm -prj decode_dispatch_int_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj decode_dispatch_int_tb_vlog.prj -log xvlog.log
