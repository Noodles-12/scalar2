...
REM
REM Generated by Vivado on Thu Apr 23 13:57:12 -0500 2026
...
echo "xvlog --incr --relax -L uvm -prj reg_file_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj reg_file_tb_vlog.prj -log xvlog.log
