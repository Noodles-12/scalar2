...
REM
REM Generated by Vivado on Wed Apr 29 21:31:25 -0500 2026
...
echo "xvlog --incr --relax -L uvm -prj rename_rs_rob_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj rename_rs_rob_tb_vlog.prj -log xvlog.log
